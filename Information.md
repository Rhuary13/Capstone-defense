...
<body class="min-h-screen bg-gray-100 flex">
  ...
  <main class="flex-1 p-8">
    <!-- Header -->
    <div class="mb-8">
      <h1 class="text-3xl font-bold text-gray-800">Training Module</h1>
    ...
    <div class="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-6 rounded-xl shadow flex items-center justify-between">
      ...
      <a href="module1.2.php" class="bg-white text-blue-600 px-4 py-2 rounded-lg font-medium hover:bg-gray-100 transition">
        Start Training
      </a>
    </div>
  </main>
